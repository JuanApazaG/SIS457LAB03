...
#define UE_PROJECT_NAME BRICK_BREAKER
#define UE_TARGET_NAME BRICK_BREAKEREditor
#define UE_MODULE_NAME "BRICK_BREAKER"
...
#define BRICK_BREAKER_API DLLEXPORT
